...
export default function OrderConversation({orderId}:{orderId:string}){
 ...
 return <section className="customer-panel"><div className="customer-section-heading"><h2>Conversation</h2><button onClick={load} className="customer-text-button">Refresh</button></div><p className="customer-small">Keep the details together here. Replies appear in the portal; this does not send an email. Showing the latest 200 messages.</p>
